...
class CCDPhotJob(CleanData):
    ...
    fits_object = models.CharField(max_length=70, null=True, blank=True)
    fits_ra = models.FloatField(default=0.0, null=True, blank=True)
    fits_dec = models.FloatField(default=0.0, null=True, blank=True)
    fits_mjd = models.FloatField(default=0.0, null=True, blank=True)
    fits_hjd = models.FloatField(default=0.0, null=True, blank=True)
    fits_exp = models.FloatField(default=0.0, null=True, blank=True)
    fits_filter = models.CharField(max_length=70, null=True, blank=True)
    fits_origin = models.CharField(max_length=70, null=True, blank=True)
    fits_observat = models.CharField(max_length=70, null=True, blank=True)
    fits_telescop = models.CharField(max_length=70, null=True, blank=True)
    fits_instrume = models.CharField(max_length=70, null=True, blank=True)
    fits_observer = models.CharField(max_length=70, null=True, blank=True)
    ...
    fits_commflag = models.CharField(max_length=255, null=True, blank=True, help_text='COMMFLAG - communication flag')
    ...
    fits_binning = models.IntegerField(null=True, blank=True, help_text='BINNING - binning factor')
    fits_pixscale = models.FloatField(null=True, blank=True, help_text='PIXELSCALE - pixel scale in arcseconds/pixel')
    fits_dateobs = models.CharField(max_length=70, null=True, blank=True, help_text='DATE-OBS - date of observation')
    fits_altitude = models.FloatField(null=True, blank=True, help_text='ALTITUDE - altitude of the observation site in meters')
    fits_azimuth = models.FloatField(null=True, blank=True, help_text='AZIMUTH - azimuth of the observation site in degrees')
