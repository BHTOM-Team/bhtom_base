    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mjd_last', models.FloatField(blank=True, null=True, verbose_name='mjd last')),
                ('mag_last', models.FloatField(blank=True, null=True, verbose_name='mag last')),
                ('importance', models.FloatField(default=0, help_text='Target importance as an integer 0-10 (10 is the highest)', verbose_name='importance')),
                ('cadence', models.FloatField(default=0, help_text='Requested cadence (0-100 days)', verbose_name='cadence')),
                ('priority', models.FloatField(blank=True, null=True, verbose_name='priority')),
                ('sun_separation', models.FloatField(blank=True, null=True, verbose_name='sun separation')),
                ...
                ('filter_last', models.CharField(blank=True, max_length=20, null=True, verbose_name='last filter')),
                ('cadence_priority', models.FloatField(blank=True, null=True, verbose_name='cadence priority')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source_name', models.CharField(choices=[('GAIA_ALERTS', 'GAIA_ALERTS name'), ('CPCS', 'CPCS name'), ('ASASSN', 'ASASSN name'), ('OGLE_EWS', 'OGLE_EWS name'), ('ZTF', 'ZTF name'), ('ATLAS', 'ATLAS name'), ('AAVSO', 'AAVSO name'), ('TNS', 'TNS name'), ('ANTARES', 'ANTARES name'), ('ZTF_DR8', 'ZTF_DR8 name'), ('SDSS', 'SDSS name'), ('NEOWISE', 'NEOWISE name'), ('ALLWISE', 'ALLWISE name'), ('CRTS', 'CRTS name'), ('LINEAR', 'LINEAR name'), ('FIRST', 'FIRST name'), ('PS1', 'PS1 name'), ('DECAPS', 'DECAPS name'), ('GAIA_DR3', 'GAIA_DR3 name'), ('GAIA_DR2', 'GAIA_DR2 name'), ('KMT_NET', 'KMT_NET name')], max_length=100, verbose_name='Source Name')),
